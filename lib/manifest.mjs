...
export function readManifest(consumerRoot, manifestName) {
  ...
  if (raw.schemaVersion > CURRENT_SCHEMA) {
    throw new Error(
      ...
      'Update your agent-scaffold clone.'
    );
  }
  return raw;
}
...
export function buildManifest({ sourceRepo, commit, mode, installedBaseSkills, installedBaseAgents, installedSkills, installedAgents }) {
