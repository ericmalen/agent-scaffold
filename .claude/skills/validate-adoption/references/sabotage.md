...
it flags the defect, then `git checkout -- .adoption && re-materialize` to
...
<fixture>/.claude/skills/ai-kit-check/references/rubric.md and the report at
<fixture>/.adoption/report.md; adversarial loss-hunt; one verdict row per
