...
> **Authoritative Source**: This skill is derived from `web/docs/test.md`. Use Vitest mock/timer APIs (`vi.*`).
...
- Only mock `nuqs` directly when URL behavior is explicitly out of scope for the test
