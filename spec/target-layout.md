...
`docs/orchestration/generation-manifest.json`); plain adoption creates none of
...
(`drift-checker`, run from a kit clone).
...
same rules as authored ones. The lifecycle skills every adoption installs
